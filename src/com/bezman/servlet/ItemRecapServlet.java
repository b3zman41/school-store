...
public class ItemRecapServlet {
    ...
    @ResponseBody
    public String itemRecapJSON(HttpServletRequest request, @RequestParam(value = "month", required = false) String month, @RequestParam(value = "day", required = false) String day, @RequestParam (value = "year", required = false) String year, @RequestParam(value = "order", required = false) String order) {
        ...
        if (school != null) {
            ...
            if (month == null && day == null && year == null)
                query = "SELECT * from sales where school='" + school + "'";
